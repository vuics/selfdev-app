...
const resources = {
    ...
    Subscription: {
      ...
      plans: {
        free: {
          name: "Explorer (Free)",
          price: "Free",
          title: "Start discovering possibilities. Discover, learn, self-host.",
          description: "For people getting started:",
          values: [
            "Unlimited human contacts",
            "Unlimited groups",
            "Unlimited personal chat messages",
            "Unlimited group chat messages",
            "3 maps",
            "-",
            "Self-host our open-source code for free",
           ],
          button: "GitHub",
        },
        basic: {
          name: "Operator (Basic)",
          title: "Start deploying and interacting with agents. Solve tasks.",
          ...
          values: [
            ...
            "-",
            "Use your LLM API keys from Vault",
        ...
        premium: {
          ...
          title: "Design automated systems and smarter workflows. Gain insights.",
          description: "Everything in Basic, and:",
          values: [
            "10 deployed agents",
            "100 maps",
            "Voice notes on Map",
            "Attached files on Map",
        ...
        enterprise: {
          ...
          price: "Get Quote",
          title: "Command intelligent systems. Full-scale control and orchestration.",
          ...
          values: [
            ...
            "Avatar agents",
            "Distributed system",
            "Social messangers bridge (WhatsApp, Telegram, Discord, Slack, etc.)",
            "Phone-line integration",
            "Synthetic UI",
            "Models Providers: OpenAI, Anthropic, Azure, Google GenAI and VertexAI, Perplexity, IBM, Mistral, Fireworks,  AI21, Upstage, XAI, Together, Groq, Cohere, Bedrock Converse, Nvidia, and others.",
            "Open-source models based on Ollama: DeepSeek, Llama, Qwen, Sky-T1, Mistral, Gemma, Codegemma, Tinyllama, etc.",
            "-",
            "Private cloud deployment with your code modifications (optional)",
            "-",
            "3dGen* agents",
            "MusicGen* agents",
            "ComputerUse* agents",
            "Train* agents",
            "CRM/ERP* agents",
            "Blockchain/SmartContract* agents",
            "Bank* agents",
            "E-commerce* agents",
            "IDE Code* agents",
            "Agentic* video conferences",
            "Agentic* VR/AR experiences",
          ],
  ...
  'ru-RU': {
    ...
    Subscription: {
      ...
      plans: {
        free: {
          name: "Исследователь (Бесплатный)",
          price: "Бесплатно",
          title: "Начните открывать возможности. Изучайте, обучайтесь, развёртывайте самостоятельно.",
          description: "Для начинающих:",
          values: [
            "Неограниченные контакты с людьми",
            "Неограниченное количество групп",
            "Неограниченные личные сообщения в чате",
            "Неограниченные групповые сообщения в чате",
            "3 карты",
            "-",
            "Развёртывайте наш открытый исходный код самостоятельно бесплатно",
          ],
          button: "GitHub",
        },
        basic: {
          name: "Оператор (Базовый)",
          title: "Начните развёртывать агентов и взаимодействовать с ними. Решайте задачи.",
          description: "Всё из Бесплатного, а также:",
          values: [
            "Неограниченные виртуальные агенты",
            "30 карт",
            "3 развернутых агента",
            "Агенты-чаты",
            "RAG-агенты",
            "Агенты-хранилища",
            "Провайдеры моделей: OpenAI (ChatGPT)",
            "-",
            "Используйте свои API-ключи LLM из Хранилища",
            "Используйте наши API-ключи LLM (оплата по факту)",
          ],
          button: "Оформить подписку",
        },
        premium: {
          name: "Стратег (Премиум)",
          title: "Проектируйте автоматизированные системы и более умные рабочие процессы. Получайте инсайты.",
          description: "Всё из Базового, а также:",
          values: [
            "10 развернутых агентов",
            "100 карт",
            "Голосовые заметки на Карте",
            "Прикреплённые файлы на Карте",
            "Агенты Распознавания Речи",
            "Агенты Синтеза Речи",
            "Агенты генерации изображений",
        ...
        enterprise: {
          ...
          title: "Управляйте интеллектуальными системами. Полный контроль и оркестровка.",
          description: "Всё из Премиума, а также:",
          values: [
            ...
            "Мост с мессенджерами (WhatsApp, Telegram, Discord, Slack и др.)",
            "Интеграция с телефонной линией",
            "Синтетический интерфейс (UI)",
            "Провайдеры моделей: OpenAI, Anthropic, Azure, Google GenAI и VertexAI, Perplexity, IBM, Mistral, Fireworks, AI21, Upstage, XAI, Together, Groq, Cohere, Bedrock Converse, Nvidia и другие.",
            "Модели с открытым исходным кодом на базе Ollama: DeepSeek, Llama, Qwen, Sky-T1, Mistral, Gemma, Codegemma, Tinyllama и др.",
            "-",
            "Развёртывание в частном облаке с возможностью модификации кода (опционально)",
            "-",
            "Агенты 3dGen*",
            "Агенты MusicGen*",
            "Агенты ComputerUse*",
            "Агенты Train*",
            "Агенты CRM/ERP*",
            "Агенты Blockchain/SmartContract*",
            "Агенты Bank*",
            "Агенты E-commerce*",
            "Агенты IDE Code*",
            "Видеоконференции с агентами*",
            "VR/AR-опыт с агентами*",
          ],
