...
const resources = {
  'en-US': {
    ...
    Home: {
      ...
      'Open-source · Decentralized · Omni-channel · Web3 Marketplace': 'Open-source · Decentralized · Omni-channel · Web3 Marketplace',
    ...
    Admin: {
      ...
      "Init Token Pools": "Init Token Pools",
      "Token pools": "Token pools",
      'Other Options': 'Other Options',

      "Error initializing subscriptions.": "Error initializing subscriptions.",
      "Error initializing token pools.": "Error initializing token pools.",
    },
    Team: {
      sectionTitle: "Team",
  ...
  'ru-RU': {
    ...
    Legal: {
      ...
      'Browse Documents': 'Просмотреть документы',
      loading: "Загрузка...",
    ...
    Admin: {
      ...
      "Token Pools": "Пулы токенов",
      "Init Token Pools": "Инициализировать пулы токенов",
      "Token pools": "Пулы токенов",
      'Other Options': 'Другие опции',

      "Error initializing subscriptions.": "Ошибка инициализации подписок.",
      "Error initializing token pools.": "Ошибка инициализации пулов токенов.",
    },
    Team: {
